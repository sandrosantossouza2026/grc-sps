    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          <div style={{ fontSize: 15, fontWeight: 600, color: 'var(--text)', marginBottom: 4 }}>Acesso restrito</div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <button
            ...
            style={{
              ...
              background: loading || !user || !pass ? 'rgba(59,130,246,0.3)' : 'var(--blue)',
      ...
      <div style={{ marginTop: 20, fontSize: 11, color: 'var(--text3)' }}>
        GRC Solutions · Sistema Preditivo para Seguradoras
      </div>
    </div>
  )
}
